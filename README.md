...
| `swimNavEnabled` | `true` | While deep underwater, follow a bent dotted line to the goal instead of a block-by-block route. Walking navigation stays in charge near the surface (it engages once your eyes are 2 blocks under and lets go when they come back within 1), when your head clears the water, and within 16 blocks of the goal |
